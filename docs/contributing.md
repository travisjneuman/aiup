...
5. Detect PATH, app bundles, npm, uv, *and* package managers — Homebrew is not the only way an app exists. Unknown local detections are read-only until their update contract is reviewed.
