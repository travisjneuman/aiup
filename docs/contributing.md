...
5. Detect PATH, app bundles, npm, uv, *and* package managers — Homebrew is not the only way an app exists. Unknown local detections are detected-only until their update/removal contract is reviewed.
